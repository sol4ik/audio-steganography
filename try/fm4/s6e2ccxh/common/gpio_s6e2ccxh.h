...
*/
/************************************************************************************/
/** \file gpio_s6e2ccxh.h
 **
 ** Header file for S6E2CCXH GPIO functions, included in gpio.h
 **
 ** History:
...
/*--- E_COL ---*/
#define SetPinFunc_E_COL(dummy)         do{ \
                                            bFM_GPIO_PFRC_P9 = 1u; \
                                        }while (0u)

/*--- E_COUT ---*/
#define SetPinFunc_E_COUT(dummy)        do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 26u, 1u,  1u ); \
                                            bFM_GPIO_PFRC_PB = 1u; \
                                        }while (0u)

/*--- E_CRS ---*/
#define SetPinFunc_E_CRS(dummy)         do{ \
                                            bFM_GPIO_PFRC_PA = 1u; \
                                        }while (0u)

/*--- E_MDC ---*/
#define SetPinFunc_E_MDC(dummy)         do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 22u, 1u,  1u ); \
                                            bFM_GPIO_PFRC_P7 = 1u; \
                                        }while (0u)

/*--- E_MDIO ---*/
#define SetPinFunc_E_MDIO(dummy)        do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 24u, 1u,  1u ); \
                                            bFM_GPIO_PFRC_P6 = 1u; \
                                        }while (0u)

/*--- E_PPS ---*/
#define SetPinFunc_E_PPS(dummy)         do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 27u, 1u,  1u ); \
                                            bFM_GPIO_PFR6_PE = 1u; \
                                        }while (0u)

/*--- E_RX00 ---*/
#define SetPinFunc_E_RX00(dummy)        do{ \
                                            bFM_GPIO_PFRC_P4 = 1u; \
                                        }while (0u)

/*--- E_RX01 ---*/
#define SetPinFunc_E_RX01(dummy)        do{ \
                                            bFM_GPIO_PFRC_P3 = 1u; \
                                        }while (0u)

/*--- E_RX02 ---*/
#define SetPinFunc_E_RX02(dummy)        do{ \
                                            bFM_GPIO_PFRC_P2 = 1u; \
                                        }while (0u)

/*--- E_RX03 ---*/
#define SetPinFunc_E_RX03(dummy)        do{ \
                                            bFM_GPIO_PFRC_P1 = 1u; \
                                        }while (0u)

/*--- E_RXCK_REFCK ---*/
#define SetPinFunc_E_RXCK_REFCK(dummy)  do{ \
                                            bFM_GPIO_PFRC_P8 = 1u; \
                                        }while (0u)

/*--- E_RXDV ---*/
#define SetPinFunc_E_RXDV(dummy)        do{ \
                                            bFM_GPIO_PFRC_P5 = 1u; \
                                        }while (0u)

/*--- E_RXER ---*/
#define SetPinFunc_E_RXER(dummy)        do{ \
                                            bFM_GPIO_PFRC_P0 = 1u; \
                                        }while (0u)

/*--- E_TCK ---*/
#define SetPinFunc_E_TCK(dummy)         do{ \
                                            bFM_GPIO_PFRC_PC = 1u; \
                                        }while (0u)

/*--- E_TX00 ---*/
#define SetPinFunc_E_TX00(dummy)        do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 18u, 1u,  1u ); \
                                            bFM_GPIO_PFRD_P1 = 1u; \
                                        }while (0u)

/*--- E_TX01 ---*/
#define SetPinFunc_E_TX01(dummy)        do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 18u, 1u,  1u ); \
                                            bFM_GPIO_PFRD_P0 = 1u; \
                                        }while (0u)

/*--- E_TX02 ---*/
#define SetPinFunc_E_TX02(dummy)        do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 19u, 1u,  1u ); \
                                            bFM_GPIO_PFRC_PF = 1u; \
                                        }while (0u)

/*--- E_TX03 ---*/
#define SetPinFunc_E_TX03(dummy)        do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 19u, 1u,  1u ); \
                                            bFM_GPIO_PFRC_PE = 1u; \
                                        }while (0u)

/*--- E_TXEN ---*/
#define SetPinFunc_E_TXEN(dummy)        do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 20u, 1u,  1u ); \
                                            bFM_GPIO_PFRD_P2 = 1u; \
                                        }while (0u)

/*--- E_TXER ---*/
#define SetPinFunc_E_TXER(dummy)        do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR14, 21u, 1u,  1u ); \
                                            bFM_GPIO_PFRC_PD = 1u; \
                                        }while (0u)
...
#endif // #ifndef __GPIO_S6E2CCXH_H__
